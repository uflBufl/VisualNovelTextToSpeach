...
`RuntimeLifecycleComponent` owns ordered shutdown and executor cleanup; startup
and runtime settings reconfiguration remain callback-backed until their shared
construction state is extracted together.
