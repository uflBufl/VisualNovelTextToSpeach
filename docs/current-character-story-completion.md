...
The read-only checkpoint after the checksum-bound cohort review has 592 queue
items: 63 approved, 36 rejected, 154 generated and still pending review, 158
...
The current cohort plan has no bindable pending cohort left. The 154 remaining
...
2. Resolve the 154 legacy pending WAVs without a listen-all shortcut. Recover
